...
export const FAB: React.FC<FABProps> = ({direction = 'horizontal', stick = false, children}) => {
  let classes = ["w-[max-content] rounded-full gap-2 bg-slate-100 dark:bg-slate-800 border-1 border-white dark:border-slate-900 ring-1 ring-slate-200 dark:ring-slate-700 shadow-md dark:drop-shadow-md"]
