...
export const Container: React.FC<ContainerProps> = ({ children }) => {
  let classes = ["h-24 pb-8 pt-4 fixed bottom-0 left-0 right-0 bg-slate-50 dark:bg-slate-900 border-t border-slate-200 dark:border-slate-800 flex flex-row justify-around items-center shadow-md"]
