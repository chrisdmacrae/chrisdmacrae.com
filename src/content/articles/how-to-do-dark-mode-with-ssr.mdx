---
title: 'How To Do Dark Mode With Server Rendered Pages'
description: | 
  When you you have server rendered pages, you can use cookies to send down a page
  that's ready for the user's selected color scheme.
created: 2023-01-15
...
Getting this to work with my partially static website proved to be a real chore, and ended in a ridiculously simple solution.
...
<Disclaimer>
  Building a statically-rendered website? Save the bytes of JavaScript and [use scripts to client-render the user's theme](./how-to-do-dark-mode-with-ssg)
</Disclaimer>
...
```html file=src/components/button.js
<script>
